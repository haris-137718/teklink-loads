...
import {
  ...
  ChevronLeft, Copy, AlertTriangle, Loader2, Eye, EyeOff, Users, Gauge, LogOut,
  Mail, ShieldCheck
} from "lucide-react";
...
.auth-icon-badge { width: 54px; height: 54px; border-radius: 15px; background: linear-gradient(145deg, var(--accent-glow), var(--accent) 55%, var(--accent-strong)); display: flex; align-items: center; justify-content: center; color: #ffffff; margin: 0 auto 18px; box-shadow: 0 8px 26px rgba(124,92,255,0.4); }
...
.auth-input:focus { outline: none; border-color: var(--accent-glow); box-shadow: 0 0 0 3px rgba(34,211,238,0.16); }
